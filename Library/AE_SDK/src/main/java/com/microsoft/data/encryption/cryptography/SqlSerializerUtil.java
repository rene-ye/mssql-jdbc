...
final class SqlSerializerUtil {
    ...
    public static byte[] normalizedValue(JDBCType destJdbcType, Object value, int destPrecision,
            int destScale) throws AAPSDKException {
        Long longValue = null;
        byte[] byteValue = null;
            ...
            switch (destJdbcType) {
                ...
                case LONGVARBINARY:
                    ...
                    if (byteArrayValue.length > destPrecision) {
                        MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_InvalidPSLength"));
                ...
                case DATETIMEOFFSET:
                    ...
                    return getNormalizedTemporal(calendar, subSecondNanos, destScale, SSType.DATETIMEOFFSET,
                            (short) minutesOffset);
                default:
                    MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_InvalidType"));
        ...
        // we don't want to throw R_errorConvertingValue error as it might expose decrypted data if source was encrypted
            ...
            MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_InvalidValueToType"));
            Object[] msgArgs = {destJdbcType};
            throw new AAPSDKException(form.format(msgArgs));
    ...
    public static Object denormalizedValue(byte[] decryptedValue, JDBCType jdbcType, SSType ssType, int precision,
            int scale, Calendar cal) throws AAPSDKException {
                ...
                try {
                    switch (ssType) {
                        ...
                        default:
                            ...
                            throw new AAPSDKException(AAPSDKResource.getResource("R_InvalidDataType"));
                    }
                    ...
                    MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_InvalidEncoding"));
    ...
    static final Object convertBytesToObject(byte[] bytesValue, JDBCType jdbcType, SSType ssType,
            int precision) throws AAPSDKException {
        switch (jdbcType) {
            case CHAR:
    ...
    private static LocalDateTime parseStringIntoLDT(String s) {
        ...
        int secondColon;
        int period;
        String formatError = AAPSDKResource.getResource("R_InvalidTimestampFormat");

        if (s == null)
            throw new java.lang.IllegalArgumentException(AAPSDKResource.getResource("R_NullString"));
    ...
    static byte[] getNormalizedTemporal(GregorianCalendar cal, int subSecondNanos, int scale, SSType ssType,
            short minutesOffset) throws AAPSDKException {
        ...
        if (SSType.DATE == ssType || SSType.DATETIME2 == ssType || SSType.DATETIMEOFFSET == ssType) {
            ...
            if (daysIntoCE < 0 || daysIntoCE >= daysSinceBaseDate(10000, 1, 1)) {
                throw new AAPSDKException(AAPSDKResource.getResource("R_InvalidTemporalValue"));
            }
    ...
    static byte[] getNormalizedDateTimeAsBytes(GregorianCalendar cal, int subSecondNanos,
            JDBCType jdbcType) throws AAPSDKException {
    ...
    static final Object convertTemporalToObject(JDBCType jdbcType, SSType ssType, Calendar timeZoneCalendar,
        ...
        switch (ssType) {
            ...
            default:
                throw new AssertionError(AAPSDKResource.getResource("R_UnexpectedSSType"));
        }
        ...
        switch (jdbcType.category) {
            ...
            default:
                throw new AssertionError(AAPSDKResource.getResource("R_UnexpectedJDBCType"));
        }
    }
    ...
    static final String readGUID(byte[] inputGUID) throws AAPSDKException {
    ...
    private static long readNanosSinceMidnightAE(byte[] value, int scale, SSType baseSSType) throws AAPSDKException {
    ...
    private static int getDaysIntoCE(byte[] datePortion, SSType baseSSType) throws AAPSDKException {
        int daysIntoCE = 0;
    ...
    static void validateMoneyRange(BigDecimal bd, JDBCType jdbcType) throws AAPSDKException {
        if (null == bd)
            return;
        ...
        MessageFormat form = new MessageFormat(AAPSDKResource.getResource("R_valueOutOfRange"));
...
enum SSType {
    ...
    static SSType of(String typeName) throws AAPSDKException {
